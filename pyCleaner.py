...
class PySecuWipe:
    def __init__(self, top=None):
        ...
        self.PNotebook1.tab(0, text="find and wipe",compound="none",underline="-1",)
        ...
        self.PNotebook1.tab(1, text="find and wipe",compound="none",underline="-1",)
        ...
        self.TLabel2.configure(text='''By Niklaus''')
